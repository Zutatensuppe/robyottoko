...
<div id="app">
  <div id="top" ref="top">
    ...
    <div id="actionbar" class="p-1">
      ...
      <a class="button is-small" :href="widgetUrl" target="_blank">Open widget</a>
    </div>
  </div>
    ...
    <table class="table is-striped" ref="table" v-if="settings">
      <tbody>
        ...
        <tr>
          ...
          <td><input class="input is-small" type="color" v-model="settings.styles.bgColor" /></td>
          <td><button class="button is-small" :disabled="settings.styles.bgColor === defaultSettings.styles.bgColor" @click="settings.styles.bgColor=defaultSettings.styles.bgColor"><i class="fa fa-remove"></i></button></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.recognition.lang" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="checkbox" v-model="settings.recognition.synthesize" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="checkbox" v-model="settings.recognition.display" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="color" v-model="settings.styles.recognition.color" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.recognition.strokeWidth" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="color" v-model="settings.styles.recognition.strokeColor" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.recognition.fontFamily" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.recognition.fontSize" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.recognition.fontWeight" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="checkbox" v-model="settings.translation.enabled" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="checkbox" v-model="settings.translation.synthesize" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.translation.langSrc" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.translation.langDst" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="color" v-model="settings.styles.translation.color" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.translation.strokeWidth" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="color" v-model="settings.styles.translation.strokeColor" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.translation.fontFamily" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.translation.fontSize" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="text" v-model="settings.styles.translation.fontWeight" /></td>
          <td><button class="button is-small"
        ...
        <tr>
          ...
          <td><input class="input is-small" type="checkbox" v-model="settings.status.enabled" /></td>
          <td><button class="button is-small" :disabled="settings.status.enabled === defaultSettings.status.enabled" @click="settings.status.enabled=defaultSettings.status.enabled"><i class="fa fa-remove"></i></button></td>
        </tr>
      </tbody>
    </table>
  </div>
